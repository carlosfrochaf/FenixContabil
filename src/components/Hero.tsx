...
export const Hero: React.FC<HeroProps> = ({ onOpenDiagnostic }) => {
  return (
    <section id="hero" className="relative min-h-[85vh] pt-24 sm:pt-36 pb-16 sm:pb-20 border-b border-[#262626] overflow-hidden">
      
      {/* 12-Column Grid Container */}
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8">
        
        {/* Top Coordinate & Metadata Bar */}
        <div className="flex flex-wrap items-center justify-between pb-6 sm:pb-8 mb-6 sm:mb-8 border-b border-[#262626] text-[10px] sm:text-[11px] font-tech text-[#8A8A8A] uppercase tracking-widest gap-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 xl:col-span-8 space-y-6 sm:space-y-8 text-left z-10">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h1 className="font-display text-3xl sm:text-5xl md:text-7xl xl:text-8xl text-[#FAFAFA] leading-[0.95] sm:leading-[0.92] tracking-tighter break-words">
                CONTABILIDADE<br />
                ESTRATÉGICA E<br />
              ...
              <p className="text-sm sm:text-base md:text-lg text-[#8A8A8A] max-w-2xl font-normal leading-relaxed pt-1">
