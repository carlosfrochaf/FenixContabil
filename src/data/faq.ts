...
export const FAQ_ITEMS: FaqItem[] = [
  {
    id: "1",
    question: "Como funciona a troca de contador para a Fênix Contábil?",
    answer: "É extremamente simples e 100% digital. Você não precisa passar por nenhum constrangimento com seu contador atual: a Fênix cuida de todo o processo de transição, solicita os arquivos fiscais e certidões necessárias e assume a responsabilidade técnica sem interromper as operações da sua empresa."
  },
  {
    id: "2",
  ...
  {
    id: "3",
    question: "Como a Fênix consegue reduzir os impostos da minha empresa legalmente?",
  ...
  {
    id: "4",
    question: "A Fênix atende apenas em Belo Horizonte ou no Brasil inteiro?",
